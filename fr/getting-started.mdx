...
<Steps>
  <Step title="Activer les politiques">
    Les politiques sont des règles qui s'exécutent avant et après chaque appel d'outil par un agent. Elles interceptent les commandes destructrices, les fuites de secrets et d'autres modes de défaillance avant qu'ils ne causent des dommages.
