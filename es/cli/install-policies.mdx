...
description: "Activa las políticas para que se ejecuten en cada llamada de herramienta del agente"
---
...
- **Nombres específicos** - habilita esas políticas (se añaden a las que ya están habilitadas)
- **`all`** - habilita todas las políticas disponibles

La instalación es acumulativa: ejecutar `--install` nuevamente añade nuevas políticas sin eliminar las existentes.
