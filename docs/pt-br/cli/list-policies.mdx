...
description: "Veja quais políticas estão habilitadas, seus parâmetros e políticas customizadas"
---
...
Exibe todas as políticas com seu status, parâmetros configurados e políticas customizadas.
