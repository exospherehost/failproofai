...
| `--scope local` | Somente Claude — instala em `<cwd>/.claude/settings.local.json`. Codex e Copilot não possuem escopo `local`. |
| `--custom <path>` / `-c` | Caminho para um arquivo JS contendo políticas de hook personalizadas |

## Comportamento

- **Sem nomes de políticas** — abre um prompt interativo para selecionar políticas
