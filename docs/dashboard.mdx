...
<Tabs>
  ...
  - Click a session ID to open its transcript — works for Claude (`~/.claude/projects/…`), Codex (`~/.codex/sessions/…`), and Copilot CLI (`~/.copilot/session-state/<id>/events.jsonl`) sessions
  </Tab>
</Tabs>
