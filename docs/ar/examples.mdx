...
يتكامل Failproof AI مع Claude Code عبر [نظام hooks الخاص به](https://docs.anthropic.com/en/docs/claude-code/hooks). عند تشغيل `failproofai policies --install`، يسجل أوامر hook في ملف `settings.json` الخاص بـ Claude Code التي تُشغّل عند كل استدعاء أداة.
...
ألزم إعداد على مستوى المشروع حتى يحصل كل مطور في فريقك على نفس السياسات.
