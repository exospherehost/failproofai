...
failproofai हुक एंट्रीज़ को Claude Code के `settings.json` से हटाता है।
...
- **विशिष्ट नाम** - उन नीतियों को अक्षम करता है लेकिन हुक इंस्टॉल रखता है
...
# किसी विशिष्ट नीति को अक्षम करें (हुक इंस्टॉल रखता है)
failproofai policies --uninstall block-sudo

# प्रत्येक स्कोप से हुक्स को हटाएं
