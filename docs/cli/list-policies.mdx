---
title: List policies
description: "See which policies are enabled, their parameters, and custom hooks"
---
...
Shows all policies with their status, configured parameters, and custom hooks.
