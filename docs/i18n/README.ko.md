...
- **32가지 기본 제공 정책** - 흔한 에이전트 오류 패턴을 즉시 감지합니다. 파괴적인 명령 차단, 시크릿 유출 방지, 에이전트를 프로젝트 경계 안에 제한, 루프 감지 등을 제공합니다.
...
| [기본 제공 정책](docs/built-in-policies.mdx) | 파라미터를 포함한 32가지 기본 제공 정책 전체 |
