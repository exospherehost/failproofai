---
title: Esempi
description: "Come configurare i hook per Claude Code e Agents SDK"
icon: book-open
---
...
Se stai sviluppando con [Agents SDK](https://docs.anthropic.com/en/docs/agents-sdk), puoi utilizzare lo stesso sistema di hook programmaticamente.
...
Effettua il commit di una config a livello di progetto in modo che ogni sviluppatore del tuo team ottenga le stesse policy.
