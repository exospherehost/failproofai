---
title: "Para agentes"
description: "Adicione o conhecimento do Failproof AI ao seu agente de codificação em um único comando. Funciona com Claude Code, Cursor, Windsurf e mais."
---
...
O Mintlify gera o `llms.txt` a partir de todas as páginas da navegação. A documentação do Failproof AI cobre a API completa — cada policy, opção e exemplo está incluído. Se encontrar algo faltando, o conteúdo fonte está em `https://docs.befailproof.ai/llms-full.txt`.
