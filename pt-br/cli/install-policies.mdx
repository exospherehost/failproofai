...
Escreve entradas de hook no `settings.json` do Claude Code para que o failproofai intercepte as chamadas de ferramentas.
...
- **Sem nomes de políticas** — abre um prompt interativo para selecionar as políticas
